...
export async function showText() {
    ...
    let text = add_spans("Beispiele von Fragezerlegungen:<hr><br><br>Wie alt war William DuVall als Black Gives Way to Blue von der RIAA mit Gold zertifiziert wurde?<br><br>return als Black Gives Way to Blue von der RIAA mit Gold zertifiziert wurde<br>;return wie alt war William Duvall on #1<hr><br><br>Hat der Kampf von Peleliu oder die Sieben Tage Kämpfe länger gedauert?<br><br>return wie lange dauerte der Kampf von Peleliu<br>;return wie lange dauerten die Sieben Tage Kämpfe<br>;return welches ist länger von #1 and #2<hr><br><br>The Love Machines hat einen Schauspieler in der Hauptrolle der in 1926 geboren wurde, bekannt für seine Nachtclub Performances in welcher Stadt?<br><br>return der Schauspieler der in 1926 geboren wurde der in der Hauptrolle in the Love Machines ist<br>;return die Nachtclub Performances für die #1 bekannt war<br>;return in welcher Stadt war #2")
